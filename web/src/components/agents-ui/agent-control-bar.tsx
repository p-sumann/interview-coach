...
const LK_TOGGLE_VARIANT_1 = [
  'data-[state=off]:bg-muted data-[state=off]:hover:bg-foreground/10',
  'data-[state=off]:[&_~_button]:bg-muted data-[state=off]:[&_~_button]:hover:bg-foreground/10',
  ...
  'dark:data-[state=off]:[&_~_button]:bg-muted dark:data-[state=off]:[&_~_button]:hover:bg-foreground/10',
];
...
const LK_TOGGLE_VARIANT_2 = [
  ...
  'data-[state=on]:bg-muted data-[state=on]:hover:bg-foreground/10',
  'data-[state=on]:border-border data-[state=on]:text-foreground data-[state=on]:ring-foreground/12',
  'data-[state=on]:focus-visible:border-ring',
  'dark:data-[state=on]:bg-muted dark:data-[state=on]:text-foreground',
];
